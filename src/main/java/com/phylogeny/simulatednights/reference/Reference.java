...
{
	public static final String MOD_ID = "simulatednights";
	public static final String MOD_NAME = "Simulated Nights";
	public static final String MOD_PATH = "com.phylogeny." + MOD_ID;
	public static final String VERSION = "@VERSION@";
	public static final String UPDATE_JSON = "@UPDATE@";
	public static final String MC_VERSIONS_ACCEPTED = "[1.9.4,1.12)";
	...
	public static final String GUI_FACTORY_CLASSPATH = MOD_PATH + ".client.config.GuiFactorySimulatedNights";
